    ...
    data() {
      return {
        swiperOption: {
          ...
          //nextButton:'.swiper-button-next', // <div class="swiper-button-next" slot="button-next"></div>
          //scrollbar:'.swiper-scrollbar', // <div class="swiper-scrollbar"   slot="scrollbar"></div>
